...
const RequestInProgress = () => {
  ...
  }, [requestTasksInprogress, selectedLocation, selectedDate, searchText]);
  ...
  const handleChangeLocation = (e) => {
    ...
    setAllTasks(filterTasks(requestTasksInprogress, newLocation, selectedDate, searchText));
  };

  const handleChangeDate = (e) => {
    const newDate = e.target.value;
    setSelectedDate(newDate);
    setAllTasks(filterTasks(requestTasksInprogress, selectedLocation, newDate, searchText));
  };
  ...
  const handleReset = () => {
    ...
    setSelectedDate('');
    setSearchText('');
    setAllTasks(requestTasksInprogress);
  };
