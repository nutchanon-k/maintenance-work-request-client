...
const MaintenanceSuccess = () => {
  ...
  useEffect(() => {
    if (maintenanceTaskSuccess) {
      setAllTasks(filterTasks(maintenanceTaskSuccess, selectedLocation, selectedDate, searchText, selectTypeOfFailure));
    }
  }, [maintenanceTaskSuccess, selectedLocation, selectedDate, searchText, selectTypeOfFailure]);
  ...
  const handleChangeLocation = (e) => {
    ...
    setAllTasks(filterTasks(maintenanceTaskSuccess, newLocation, selectedDate, searchText, selectTypeOfFailure));
  };

  const handleChangeDate = (e) => {
    const newDate = e.target.value;
    setSelectedDate(newDate);
    setAllTasks(filterTasks(maintenanceTaskSuccess, selectedLocation, newDate, searchText, selectTypeOfFailure));
  };

  const handleChangeTypeofFailure = (e) => {
    const newTypeofFailure = e.target.value;
    setSelectTypeOfFailure(newTypeofFailure);
    setAllTasks(filterTasks(maintenanceTaskSuccess, selectedLocation, selectedDate, searchText, newTypeofFailure));
  };
  ...
  const handleReset = () => {
    ...
    setAllTasks(maintenanceTaskSuccess);
  };
