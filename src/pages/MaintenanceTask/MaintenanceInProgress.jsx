...
const MaintenanceInProgress = () => {
  ...
  useEffect(() => {
    if (maintenanceTaskInprogress) {
      setAllTasks(filterTasks(maintenanceTaskInprogress, selectedLocation, selectedDate, searchText, selectTypeOfFailure));
    }
  }, [maintenanceTaskInprogress, selectedLocation, selectedDate, searchText, selectTypeOfFailure]);
  ...
  const handleChangeLocation = (e) => {
    ...
    setAllTasks(filterTasks(maintenanceTaskInprogress, newLocation, selectedDate, searchText, selectTypeOfFailure));
  };

  const handleChangeDate = (e) => {
    const newDate = e.target.value;
    setSelectedDate(newDate);
    setAllTasks(filterTasks(maintenanceTaskInprogress, selectedLocation, newDate, searchText, selectTypeOfFailure));
  };

  const handleChangeTypeofFailure = (e) => {
    const newTypeofFailure = e.target.value;
    setSelectTypeOfFailure(newTypeofFailure);
    setAllTasks(filterTasks(maintenanceTaskInprogress, selectedLocation, selectedDate, searchText, newTypeofFailure));
  };
  ...
  const handleReset = () => {
    ...
    setAllTasks(maintenanceTaskInprogress);
  };
