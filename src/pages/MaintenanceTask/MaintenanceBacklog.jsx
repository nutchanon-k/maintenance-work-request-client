...
const MaintenanceBacklog = () => {
  ...
  useEffect(() => {
    if (maintenanceTaskBacklog) {
      setAllTasks(filterTasks(maintenanceTaskBacklog, selectedLocation, selectedDate, searchText, selectTypeOfFailure));
    }
  }, [maintenanceTaskBacklog, selectedLocation, selectedDate, searchText, selectTypeOfFailure]);
  ...
  const handleChangeLocation = (e) => {
    ...
    setAllTasks(filterTasks(maintenanceTaskBacklog, newLocation, selectedDate, searchText, selectTypeOfFailure));
  };

  const handleChangeDate = (e) => {
    const newDate = e.target.value;
    setSelectedDate(newDate);
    setAllTasks(filterTasks(maintenanceTaskBacklog, selectedLocation, newDate, searchText, selectTypeOfFailure));
  };

  const handleChangeTypeofFailure = (e) => {
    const newTypeofFailure = e.target.value;
    setSelectTypeOfFailure(newTypeofFailure);
    setAllTasks(filterTasks(maintenanceTaskBacklog, selectedLocation, selectedDate, searchText, newTypeofFailure));
  };
  ...
  const handleReset = () => {
    ...
    setAllTasks(maintenanceTaskBacklog);
  };
